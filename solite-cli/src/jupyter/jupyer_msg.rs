...
impl JupyterMessage {
    ...
    fn from_raw_message(raw_message: RawMessage) -> Result<JupyterMessage, AnyError> {
    ...
    //pub(crate) fn metadata(&self) -> &serde_json::Value {&self.metadata}
    //pub(crate) fn content(&self) -> &serde_json::Value {&self.content}
